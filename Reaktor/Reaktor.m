...
CPcoeff_H2O = [72.43 1.039*10^-2 -1.497*10^-6 0 ];          %Koffecienter för Cp [A B C D]
...
dH0_Butan   = -134.2*10^3; %Formationsentalpi Butan
dH0_Buten   = -17.9*10^3;  %Formationsentalpi Buten
dH0_H2      = 0;

dH0 = dH0_Buten+dH0_H2-dH0_Butan; %Formationsentalpi för rektionen
...
[W1,U1] = ode15s(@PFR_ode,Wspan1,U01,[],dH0,k,K1,K2,P,A,Ea);
...
[W2,U2] = ode15s(@PFR_ode,Wspan2,U02,[],dH0,k,K1,K2,P,A,Ea);
